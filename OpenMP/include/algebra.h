...
void add(double* a, SpMat&  A, int row, double scalar); // sparse matrix, dense vector
...
/**************************************************
 * compute spectral norm of a symmetric psd matrix
 * Input:
 *      A -- a dense matrix
 * Output: the result spectral norm
 *************************************************/

double Matrix_spec_norm(Matrix &A);
double Matrix_spec_norm(SpMat &A);
